...
namespace CProyect.Forms
{
    ...
    public partial class CatGamingLaptops : MaterialForm
    {
        private readonly MaterialSkinManager materialSkinManager;
        public CatGamingLaptops()
        {
            InitializeComponent();
        ...
        private void btn_compra6_Click(object sender, EventArgs e)
        {
            switch (comprados)
            {
                case 0:
                    comprados = comprados + 1;
                    producto1 = gbox_6.Text;
                    precio1 = Convert.ToDouble(lbl_precio6.Text.Remove(0, 9));
                    cantidad1 = Convert.ToInt16(cant_6.Value);
                    MessageBox.Show("Se ha añadido el producto a la carretilla", "Producto Añadido");

                    break;
                case 1:
                    comprados = comprados + 1;
                    producto2 = gbox_6.Text;
                    precio2 = Convert.ToDouble(lbl_precio6.Text.Remove(0, 9));
                    cantidad2 = Convert.ToInt16(cant_6.Value);
                    MessageBox.Show("Se ha añadido el producto a la carretilla", "Producto Añadido");
                ...
                case 2:
                    comprados = comprados + 1;
                    producto3 = gbox_6.Text;
                    precio3 = Convert.ToDouble(lbl_precio6.Text.Remove(0, 9));
                    cantidad3 = Convert.ToInt16(cant_6.Value);
                    MessageBox.Show("Se ha añadido el producto a la carretilla", "Producto Añadido");
                ...
                case 3:
                    comprados = comprados + 1;
                    producto4 = gbox_6.Text;
                    precio4 = Convert.ToDouble(lbl_precio6.Text.Remove(0, 9));
                    cantidad4 = Convert.ToInt16(cant_6.Value);
                    MessageBox.Show("Se ha añadido el producto a la carretilla", "Producto Añadido");
